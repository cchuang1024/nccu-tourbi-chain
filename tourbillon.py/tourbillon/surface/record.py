...
NAME_ADDRESS = \
    m().set('1d259e3852419ddf6c75c6db2aa751df7b7e9319', 'Alice') \
        .set('19e74a1813c73291c97f271bfae3a947eb385eac', 'Bob') \
        .set('94020a8513391af84cfa320e56c13f0ca724d427', 'Cloe') \
        .set('b450c1d01fe18e9d278255b5a240bc9deb3a0664', 'Devil') \
        .set('534eb986dd72630ecfc494eb2843f31496a65d9b', 'Elijah')
...
def build_model(tsa):
    vm = ViewModel(tsa.timestamp, NAME_ADDRESS[tsa.address], tsa.digest, '存證')
    return vm._asdict()
